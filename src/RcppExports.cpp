...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(LSVCMM(response, subject, response_time, vcm_covariates, fixed_covariates, offset, family_name, link, kernel_name, estimated_time, kernel_scale, n_kernel_scale, penalty_name, penalize_intercept, alpha, scad_a, adaptive, lambda, lambda_factor, n_lambda, working_covariance, estimate_variance_components, variance_ratio, correlation, max_rounds, max_iter, rel_tol, verbose, update_method, backtracking_fraction));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_LSVCMM_LSVCMM", (DL_FUNC) &_LSVCMM_LSVCMM, 30},
    {NULL, NULL, 0}
};
